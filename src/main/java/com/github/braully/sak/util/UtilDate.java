...
public class UtilDate {
     ...
     *
     */
    private static String[] datePatternsDMY = new String[]{"dd-MM-yyyy", "dd-MM-yy", "dd/MM/yyyy", "dd/MM/yy"};
    private static String[] datePatternsDM = new String[]{"dd-MM", "dd-MM", "dd/MM", "dd/MM"};
    private static String[] datePatternsD = new String[]{"dd-MM", "dd-MM", "dd/MM", "dd/MM"};
    ...
    private static Date parseDataDM(String texto) {
        Date data = null;
    ...
    private static Date parseDataDMY(String texto) {
        Date data = null;
